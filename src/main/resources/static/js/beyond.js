...
if (location.pathname != "/index-rtl-fa.jsp" && location.pathname != "/index-rtl-ar.jsp") {
    ...
    $("#sidebar-collapse").on('click', function () {
        ...
        if (b) {
            ...
            if ($('.page-sidebar').hasClass('sidebar-fixed')) {
                var position = (readCookie("rtl-support") || location.pathname == "/index-rtl-fa.jsp" || location.pathname == "/index-rtl-ar.jsp") ? 'right' : 'left';
