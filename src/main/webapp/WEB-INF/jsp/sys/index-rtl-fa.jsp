...
<head>
    ...
    <style>
        @font-face {
            font-family: 'WYekan';
            src: url('http://s3.amazonaws.com//fonts/BYekan.woff') format('woff');
            font-weight: normal;
            font-style: normal;
        }
    </style>
    ...
    <link href="/css/4095-rtl.min.css" rel="stylesheet" type="text/css" />
    <link href="/css/demo.min.css" rel="stylesheet" />
    <link href="/css/typicons.min.css" rel="stylesheet" />
    <link href="/css/animate.min.css" rel="stylesheet" />
    <link id="skin-link" href="index-rtl-fa.jsp" rel="stylesheet" type="text/css" />
</head>
<!-- /Head -->
<!-- Body -->
<body>
        ...
        <div class="navbar-inner">
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-right">
                    <a href="index-rtl-fa.jsp#" class="navbar-brand">
                        <small>
                            <img src="/img/logo-rtl.png" alt="" />
                        </small>
                    </a>
                </div>
                <!-- /Navbar Barnd -->
                ...
                <div class="navbar-header pull-left">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li>
                                <a class=" dropdown-toggle" data-toggle="dropdown" title="Help" href="index-rtl-fa.jsp#">
                            ...
                            <li>
                                <a class="wave in dropdown-toggle" data-toggle="dropdown" title="Help" href="index-rtl-fa.jsp#">
                            ...
                            <li>
                                <a class="dropdown-toggle" data-toggle="dropdown" title="Tasks" href="index-rtl-fa.jsp#">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <!--Avatar Area-->
                                    <li class="edit">
                                        <a href="profile.jsp" class="pull-left">پروفایل</a>
                                        <a href="index-rtl-fa.jsp#" class="pull-right">تنظیمات</a>
                                    </li>
                                    <!--Theme Selector Area-->
                                    <li class="theme-area">
                                        <ul class="colorpicker" id="skin-changer">
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#5DB2FF;" rel="/css/skins/blue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#2dc3e8;" rel="/css/skins/azure.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#03B3B2;" rel="/css/skins/teal.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#53a93f;" rel="/css/skins/green.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#FF8F32;" rel="/css/skins/orange.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#cc324b;" rel="/css/skins/pink.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#AC193D;" rel="/css/skins/darkred.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#8C0095;" rel="/css/skins/purple.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#0072C6;" rel="/css/skins/darkblue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#585858;" rel="/css/skins/gray.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#474544;" rel="/css/skins/black.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-fa.jsp#" style="background-color:#001940;" rel="/css/skins/deepblue.min.css"></a></li>
                                        </ul>
                                    </li>
                                    <!--/Theme Selector Area-->
                                    <li class="dropdown-footer">
                            ...
                            <a id="btn-setting" title="Setting" href="index-rtl-fa.jsp#">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        <a href="databoxes.jsp">
                            ...
                            <span class="menu-text"> باکس داده ها </span>
                        </a>
                    </li>
                    <!--Widgets-->
                    <li>
                        <a href="widgets.jsp">
                            ...
                            <span class="menu-text"> ابزارک ها </span>
                        </a>
                    </li>
                    <!--UI Elements-->
                    <li>
                        <a href="index-rtl-fa.jsp#" class="menu-dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="alerts.jsp">
                                    <span class="menu-text">هشدارها و راهنماها</span>
                                </a>
                            </li>
                            <li>
                                <a href="modals.jsp">
                            ...
                            <li>
                                <a href="treeview.jsp">
                                    <span class="menu-text">درخت ها</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="tables-simple.jsp">
                                    <span class="menu-text">ساده و انعطاف پذیر</span>
                                </a>
                            </li>
                            <li>
                                <a href="tables-data.jsp">
                                    <span class="menu-text">جداول داده ها</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="index-rtl-fa.jsp#" class="menu-dropdown">
                            ...
                            <span class="menu-text"> فرم ها </span>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="form-layouts.jsp">
                                    <span class="menu-text">چینش فرم ها</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="form-validation.jsp">
                                    <span class="menu-text">اعتبارسنجی</span>
                                </a>
                            </li>
                            <li>
                                <a href="form-editors.jsp">
                                    <span class="menu-text">ویرایشگرها</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="index-rtl-fa.jsp#" class="menu-dropdown">
                            ...
                            <span class="menu-text"> نمودارها </span>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="flot.jsp">
                                    <span class="menu-text">نمودار فلوت</span>
                                </a>
                            </li>

                            <li>
                                <a href="morris.jsp">
                                    <span class="menu-text">نمودار موریس</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="easypiecharts.jsp">
                                    <span class="menu-text">نمودار ایزی پای</span>
                                </a>
                            </li>
                            <li>
                                <a href="chartjs.jsp">
                                    <span class="menu-text"> چارت جی اس</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="inbox.jsp">
                                    <span class="menu-text">اینباکس</span>
                                </a>
                            </li>

                            <li>
                                <a href="message-view.jsp">
                                    <span class="menu-text">مشاهده ایمیل</span>
                                </a>
                            </li>
                            <li>
                                <a href="message-compose.jsp">
                                    <span class="menu-text">ایجاد ایمیل</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="timeline.jsp">
                                    <span class="menu-text">جدول زمانی</span>
                                </a>
                            </li>
                            <li>
                                <a href="pricing.jsp">
                                    <span class="menu-text">جدول قیمت گذاری</span>
                                </a>
                            </li>

                            <li>
                                <a href="invoice.jsp">
                                    <span class="menu-text">صورت حساب</span>
                                </a>
                            </li>

                            <li>
                                <a href="login.jsp">
                                    <span class="menu-text">ورود به سیستم</span>
                                </a>
                            </li>
                            <li>
                                <a href="register.jsp">
                            ...
                            <li>
                                <a href="lock.jsp">
                                    <span class="menu-text">صفحه قفل</span>
                                </a>
                            </li>
                            <li>
                                <a href="typography.jsp">
                                    <span class="menu-text"> تایپوگرافی </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="error-404.jsp">
                                    <span class="menu-text">خطای 404</span>
                                </a>
                            </li>

                            <li>
                                <a href="error-500.jsp">
                                    <span class="menu-text">خطای 500</span>
                                </a>
                            </li>
                            <li>
                                <a href="blank.jsp">
                                    <span class="menu-text">صفحه خالی</span>
                                </a>
                            </li>
                            <li>
                                <a href="grid.jsp">
                                    <span class="menu-text"> گرید</span>
                                </a>
                            </li>
                            <li>
                                <a href="index-rtl-fa.jsp#" class="menu-dropdown">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="index-rtl-fa.jsp#">
                                            ...
                                            <span class="menu-text">سطح سوم</span>
                                        </a>
                                    </li>
                                        ...
                                        <ul class="submenu">
                                            <li>
                                                <a href="index-rtl-fa.jsp#">
                                                    ...
                                                    <span class="menu-text">یک آیتم</span>
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="index-rtl-fa.jsp#">
                                                    ...
                                                    <span class="menu-text">آیتمی دیگر</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                    ...
                    <li class="active open">
                        <a href="index-rtl-fa.jsp#" class="menu-dropdown">
                            ...
                            <span class="menu-text"> راست به چپ </span>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="index-rtl-ar.jsp">
                                    <span class="menu-text">چینش عربی</span>
                                </a>
                            </li>

                            <li class="active">
                                <a href="index-rtl-fa.jsp">
                                    <span class="menu-text">چینش فارسی</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="index-rtl-fa.jsp#">خانه</a>
                        </li>
                ...
                <div class="page-header position-relative">
                    ...
                    <div class="header-buttons">
                        <a class="sidebar-toggler" href="index-rtl-fa.jsp#">
                            <i class="fa fa-arrows-h"></i>
                        </a>
                        <a class="refresh" id="refresh-toggler" href="index-rtl-fa.jsp">
                            <i class="glyphicon glyphicon-refresh"></i>
                        </a>
                        <a class="fullscreen" id="fullscreen-toggler" href="index-rtl-fa.jsp#">
                                        ...
                                        <div class="box-tabbs">
                                            <div class="tabbable">
                                                <ul class="nav nav-tabs tabs-flat  nav-justified" id="myTab11">
                                                    <li class="active">
                                                        <a data-toggle="tab" href="index-rtl-fa.jsp#realtime">
                                                            بازدید لحظه ای
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a data-toggle="tab" href="index-rtl-fa.jsp#visits">
                                                            بازدیدها
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a data-toggle="tab" id="contacttab" href="index-rtl-fa.jsp#bandwidth">
                                                            پهنای باند
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a data-toggle="tab" href="index-rtl-fa.jsp#sales">
                                                            آمار فروش
                                                        </a>
                                                    </li>
                                                </ul>
                            ...
                            <div class="orders-container">
                                ...
                                <ul class="orders-list">
                                    <li class="order-item">
                                        ...
                                        <a class="item-more" href="index-rtl-fa.jsp">
                                            <i></i>
                                        </a>
                                    </li>
                                ...
                                <div class="orders-footer">
                                    <a class="show-all" href="index-rtl-fa.jsp"><i class="fa fa-angle-down"></i> نمایش همه</a>
                                    <div class="help">
                                        <a href="index-rtl-fa.jsp"><i class="fa fa-question"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="task-container">
                                        ...
                                        <ul class="tasks-list">
                                            <li class="task-item">
                                                ...
                                                <div class="task-creator"><a href="index-rtl-fa.jsp">بابک خرمدین</a></div>
                                            ...
                                            <li class="task-item">
                                                ...
                                                <div class="task-creator"><a href="index-rtl-fa.jsp">بهرنگ علی فر</a></div>
                                                <div class="task-assignedto">منسوب به شما</div>
                                            </li>
                                            <li class="task-item">
                                                <div class="task-check">
                                                ...
                                                <div class="task-creator"><a href="index-rtl-fa.jsp">بیل گیتز</a></div>
                                            ...
                                            <div class="tickets-container">
                                                <ul class="tickets-list">
                                                    <li class="ticket-item">
                                                        <div class="row">
                                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                                <img src="/img/avatars/adam-jansen.jpg" class="user-avatar">
                                                    ...
                                                    <li class="ticket-item">
                                                        <div class="row">
                                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                                <img src="/img/avatars/divyia.jpg" class="user-avatar">
                                                    ...
                                                    <li class="ticket-item">
                                                        <div class="row">
                                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                                <img src="/img/avatars/Matt-Cheuvront.jpg" class="user-avatar">
                                                    ...
                                                    <li class="ticket-item">
                                                        <div class="row">
                                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                                <img src="/img/avatars/Sergey-Azovskiy.jpg" class="user-avatar">
                                                    ...
                                                    <li class="ticket-item">
                                                        <div class="row">
                                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                                <img src="/img/avatars/John-Smith.jpg" class="user-avatar">
