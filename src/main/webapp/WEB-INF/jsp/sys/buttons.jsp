...
<head>
    ...
    <link id="bootstrap-rtl-link" href="buttons.jsp" rel="stylesheet" />
    ...
    <link id="skin-link" href="buttons.jsp" rel="stylesheet" type="text/css" />
        ...
        <div class="navbar-inner">
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="buttons.jsp#" class="navbar-brand">
                        <small>
                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li>
                                <a class=" dropdown-toggle" data-toggle="dropdown" title="Help" href="buttons.jsp#">
                            ...
                            <li>
                                <a class="wave in dropdown-toggle" data-toggle="dropdown" title="Help" href="buttons.jsp#">
                            ...
                            <li>
                                <a class="dropdown-toggle" data-toggle="dropdown" title="Tasks" href="buttons.jsp#">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li class="edit">
                                        ...
                                        <a href="buttons.jsp#" class="pull-right">Setting</a>
                                    </li>
                                    <!--Theme Selector Area-->
                                    <li class="theme-area">
                                        <ul class="colorpicker" id="skin-changer">
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#5DB2FF;" rel="/css/skins/blue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#2dc3e8;" rel="/css/skins/azure.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#03B3B2;" rel="/css/skins/teal.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#53a93f;" rel="/css/skins/green.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#FF8F32;" rel="/css/skins/orange.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#cc324b;" rel="/css/skins/pink.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#AC193D;" rel="/css/skins/darkred.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#8C0095;" rel="/css/skins/purple.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#0072C6;" rel="/css/skins/darkblue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#585858;" rel="/css/skins/gray.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#474544;" rel="/css/skins/black.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="buttons.jsp#" style="background-color:#001940;" rel="/css/skins/deepblue.min.css"></a></li>
                                        </ul>
                                    </li>
                                    <!--/Theme Selector Area-->
                                    <li class="dropdown-footer">
                            ...
                            <a id="btn-setting" title="Setting" href="buttons.jsp#">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li class="active open">
                        <a href="buttons.jsp#" class="menu-dropdown">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="buttons.jsp#">Home</a>
                        </li>
                        <li>
                            <a href="buttons.jsp#">UI Elements</a>
                        </li>
                ...
                <div class="page-header position-relative">
                    ...
                    <div class="header-buttons">
                        <a class="sidebar-toggler" href="buttons.jsp#">
                            <i class="fa fa-arrows-h"></i>
                        </a>
                        <a class="refresh" id="refresh-toggler" href="buttons.jsp">
                            <i class="glyphicon glyphicon-refresh"></i>
                        </a>
                        <a class="fullscreen" id="fullscreen-toggler" href="buttons.jsp#">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-xs-12">
                            ...
                            <div class="well with-header with-footer">
                                ...
                                <div class="clearfix">
                                    <a href="buttons.jsp#" class="btn btn-yellow btn-block shiny">Link</a>
                                ...
                                <div class="buttons-preview">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-danger" role="menu">
                                            <li>
                                                <a href="buttons.jsp#">Action</a>
                                            </li>
                                            <li>
                                                <a href="buttons.jsp#">Another action</a>
                                            </li>
                                            <li>
                                                <a href="buttons.jsp#">Something else here</a>
                                            </li>
                                            <li class="divider">
                                            </li>
                                            <li>
                                                <a href="buttons.jsp#">Separated link</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="btn-group">
                                ...
                                <div class="buttons-preview">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="buttons.jsp#">Dropdown link</a>
                                                </li>
                                                <li>
                                                    <a href="buttons.jsp#">Dropdown link</a>
                                                </li>
                            ...
                            <div class="well with-header with-footer">
                                ...
                                <div class="buttons-preview">
                                    <div class="btn-group btn-group-justified">
                                        <a href="buttons.jsp#" class="btn btn-default">Left</a>
                                        <a href="buttons.jsp#" class="btn btn-default">Middle</a>
                                        <a href="buttons.jsp#" class="btn btn-default">Right</a>
                                    </div>
                                    <div class="btn-group btn-group btn-group-justified">
                                        <a href="buttons.jsp#" class="btn btn-palegreen">Good</a>
                                        <a href="buttons.jsp#" class="btn btn-warning">Bad</a>
                                        <a href="buttons.jsp#" class="btn btn-danger">Ugly</a>
                                    </div>
