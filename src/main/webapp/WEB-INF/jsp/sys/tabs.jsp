...
<head>
    ...
    <link id="bootstrap-rtl-link" href="tabs.jsp" rel="stylesheet" />
    ...
    <link id="skin-link" href="tabs.jsp" rel="stylesheet" type="text/css" />
        ...
        <div class="navbar-inner">
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="tabs.jsp#" class="navbar-brand">
                        <small>
                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li>
                                <a class=" dropdown-toggle" data-toggle="dropdown" title="Help" href="tabs.jsp#">
                            ...
                            <li>
                                <a class="wave in dropdown-toggle" data-toggle="dropdown" title="Help" href="tabs.jsp#">
                            ...
                            <li>
                                <a class="dropdown-toggle" data-toggle="dropdown" title="Tasks" href="tabs.jsp#">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li class="edit">
                                        ...
                                        <a href="tabs.jsp#" class="pull-right">Setting</a>
                                    </li>
                                    <!--Theme Selector Area-->
                                    <li class="theme-area">
                                        <ul class="colorpicker" id="skin-changer">
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#5DB2FF;" rel="/css/skins/blue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#2dc3e8;" rel="/css/skins/azure.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#03B3B2;" rel="/css/skins/teal.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#53a93f;" rel="/css/skins/green.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#FF8F32;" rel="/css/skins/orange.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#cc324b;" rel="/css/skins/pink.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#AC193D;" rel="/css/skins/darkred.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#8C0095;" rel="/css/skins/purple.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#0072C6;" rel="/css/skins/darkblue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#585858;" rel="/css/skins/gray.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#474544;" rel="/css/skins/black.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="tabs.jsp#" style="background-color:#001940;" rel="/css/skins/deepblue.min.css"></a></li>
                                        </ul>
                                    </li>
                                    <!--/Theme Selector Area-->
                                    <li class="dropdown-footer">
                            ...
                            <a id="btn-setting" title="Setting" href="tabs.jsp#">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li class="active open">
                        <a href="tabs.jsp#" class="menu-dropdown">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="tabs.jsp#">Home</a>
                        </li>
                        <li>
                            <a href="tabs.jsp#">Elements</a>
                        </li>
                ...
                <div class="page-header position-relative">
                    ...
                    <div class="header-buttons">
                        <a class="sidebar-toggler" href="tabs.jsp#">
                            <i class="fa fa-arrows-h"></i>
                        </a>
                        <a class="refresh" id="refresh-toggler" href="tabs.jsp">
                            <i class="glyphicon glyphicon-refresh"></i>
                        </a>
                        <a class="fullscreen" id="fullscreen-toggler" href="tabs.jsp#">
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs" id="myTab">
                                            <li class="active">
                                                <a data-toggle="tab" href="tabs.jsp#home">
                                                    Home
                                                </a>
                                            </li>

                                            <li class="tab-red">
                                                <a data-toggle="tab" href="tabs.jsp#profile">
                                                    Profile
                                                </a>
                                            </li>

                                            <li class="dropdown">
                                                <a data-toggle="dropdown" class="dropdown-toggle" href="tabs.jsp#">
                                                    Dropdown
                                                    <b class="caret"></b>
                                                </a>
                                                ...
                                                <ul class="dropdown-menu dropdown-blue">
                                                    <li>
                                                        <a data-toggle="tab" href="tabs.jsp#dropdown1">@fat</a>
                                                    </li>

                                                    <li>
                                                        <a data-toggle="tab" href="tabs.jsp#dropdown2">@mdo</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="tabbable tabs-below">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab2">
                                            <li class="active">
                                                <a data-toggle="tab" href="tabs.jsp#home2">Home</a>
                                            </li>

                                            <li>
                                                <a data-toggle="tab" href="tabs.jsp#profile2">Profile</a>
                                            </li>

                                            <li>
                                                <a data-toggle="tab" href="tabs.jsp#dropdown12">More</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="horizontal-space"></div>
                                    ...
                                    <div class="tabbable tabs-left">
                                        <ul class="nav nav-tabs" id="myTab3">
                                            <li class="active tab-sky">
                                                <a data-toggle="tab" href="tabs.jsp#home3">
                                                    Home
                                                </a>
                                            </li>

                                            <li class="tab-red">
                                                <a data-toggle="tab" href="tabs.jsp#profile3">
                                                    Profile
                                                </a>
                                            </li>

                                            <li class="tab-orange">
                                                <a data-toggle="tab" href="tabs.jsp#dropdown13">
                                                    More
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="tabbable tabs-right">
                                        <ul class="nav nav-tabs" id="myTab4">
                                            <li class="active tab-green">
                                                <a data-toggle="tab" href="tabs.jsp#home4">Home</a>
                                            </li>

                                            <li class="tab-purple">
                                                <a data-toggle="tab" href="tabs.jsp#profile4">Profile</a>
                                            </li>

                                            <li class="tab-darkorange">
                                                <a data-toggle="tab" href="tabs.jsp#dropdown14">More</a>
                                            </li>
                                        </ul>
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs nav-justified" id="myTab5">
                                            <li class="active">
                                                <a data-toggle="tab" href="tabs.jsp#home5">
                                                    Home
                                                </a>
                                            </li>

                                            <li class="tab-red">
                                                <a data-toggle="tab" href="tabs.jsp#profile5">
                                                    Profile
                                                </a>
                                            </li>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-blue">
                                                    <li>
                                                        <a data-toggle="tab" href="tabs.jsp#dropdown5">@fat</a>
                                                    </li>

                                                    <li>
                                                        <a data-toggle="tab" href="tabs.jsp#dropdown15">@mdo</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="tabbable tabs-below">
                                        ...
                                        <ul class="nav nav-tabs nav-justified" id="myTab6">
                                            <li class="active">
                                                <a data-toggle="tab" href="tabs.jsp#home6">Home</a>
                                            </li>

                                            <li>
                                                <a data-toggle="tab" href="tabs.jsp#profile6">Profile</a>
                                            </li>

                                            <li>
                                                <a data-toggle="tab" href="tabs.jsp#dropdown16">More</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="horizontal-space"></div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs" id="myTab7">
                                            <li class="active">
                                                <a data-toggle="tab" href="tabs.jsp#home7">
                                                    Home
                                                </a>
                                            </li>

                                            <li class="tab-red">
                                                <a data-toggle="tab" href="tabs.jsp#profile7">
                                                    Profile
                                                </a>
                                            </li>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-blue">
                                                    <li>
                                                        <a data-toggle="tab" href="tabs.jsp#dropdown7">@fat</a>
                                                    </li>

                                                    <li>
                                                        <a data-toggle="tab" href="tabs.jsp#dropdown17">@mdo</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="tabbable tabs-below">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab8">
                                            <li class="active">
                                                <a data-toggle="tab" href="tabs.jsp#home8">Home</a>
                                            </li>

                                            <li>
                                                <a data-toggle="tab" href="tabs.jsp#profile8">Profile</a>
                                            </li>

                                            <li>
                                                <a data-toggle="tab" href="tabs.jsp#dropdown8">More</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="horizontal-space"></div>
                                            ...
                                            <div class="widget-main ">
                                                <div class="tabbable">
                                                    <ul class="nav nav-tabs" id="myTab9">
                                                        <li class="active">
                                                            <a data-toggle="tab" href="tabs.jsp#home9">
                                                                Home
                                                            </a>
                                                        </li>

                                                        <li class="tab-red">
                                                            <a data-toggle="tab" href="tabs.jsp#profile9">
                                                                Messages
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-info">
                                                                <li>
                                                                    <a data-toggle="tab" href="tabs.jsp#dropdown9">@fat</a>
                                                                </li>

                                                                <li>
                                                                    <a data-toggle="tab" href="tabs.jsp#dropdown19">@mdo</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                    ...
                                    <div class="well with-header">
                                        ...
                                        <div class="tabbable">
                                            <ul class="nav nav-tabs nav-justified" id="myTab10">
                                                <li class="active">
                                                    <a data-toggle="tab" href="tabs.jsp#home10">
                                                        Home
                                                    </a>
                                                </li>

                                                <li class="tab-red">
                                                    <a data-toggle="tab" href="tabs.jsp#profile10">
                                                        Messages
                                                    </a>
                                                </li>
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-info">
                                                        <li>
                                                            <a data-toggle="tab" href="tabs.jsp#dropdown10">@fat</a>
                                                        </li>

                                                        <li>
                                                            <a data-toggle="tab" href="tabs.jsp#dropdown20">@mdo</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="widget-main ">
                                                <div class="tabbable">
                                                    <ul class="nav nav-tabs tabs-flat" id="myTab11">
                                                        <li class="active">
                                                            <a data-toggle="tab" href="tabs.jsp#home11">
                                                                Home
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a data-toggle="tab" href="tabs.jsp#profile11">
                                                                Messages
                                                            </a>
                                                        </li>
                                                    </ul>
                                    ...
                                    <div class="widget">
                                        <div class="widget-header bordered-bottom bordered-blue">
                                            ...
                                            <div class="widget-buttons">
                                                <a href="tabs.jsp#" data-toggle="maximize">
                                                    <i class="fa fa-expand"></i>
                                                </a>
                                                <a href="tabs.jsp#" data-toggle="collapse">
                                                    <i class="fa fa-minus"></i>
                                                </a>
                                                <a href="tabs.jsp#" data-toggle="dispose">
                                            ...
                                            <div class="widget-main ">
                                                <div class="panel-group accordion" id="accordion">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading ">
                                                            <h4 class="panel-title">
                                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="tabs.jsp#collapseOne">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="tabs.jsp#collapseTwo">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="tabs.jsp#collapseThree">
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="panel-group accordion" id="accordions">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordions" href="tabs.jsp#collapseOnes">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordions" href="tabs.jsp#collapseTwos">
                                                        Collapsible Group Item #2
                                                    </a>
                                                </h4>
                                            </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordions" href="tabs.jsp#collapseThrees">
                                                        Collapsible Group Item #3
                                                    </a>
                                                </h4>
                                            </div>
