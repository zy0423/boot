...
<head>
    ...
    <link id="skin-link" href="index-rtl-ar.jsp" rel="stylesheet" type="text/css" />
        ...
        <div class="navbar-inner">
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-right">
                    <a href="index-rtl-ar.jsp#" class="navbar-brand">
                        <small>
                ...
                <div class="navbar-header pull-left">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li>
                                <a class=" dropdown-toggle" data-toggle="dropdown" title="Help" href="index-rtl-ar.jsp#">
                            ...
                            <li>
                                <a class="wave in dropdown-toggle" data-toggle="dropdown" title="Help" href="index-rtl-ar.jsp#">
                            ...
                            <li>
                                <a class="dropdown-toggle" data-toggle="dropdown" title="Tasks" href="index-rtl-ar.jsp#">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <!--Avatar Area-->
                                    <li class="edit">
                                        <a href="profile.jsp" class="pull-left">الملف الشخصي</a>
                                        <a href="index-rtl-ar.jsp#" class="pull-right">اعداد</a>
                                    </li>
                                    <!--Theme Selector Area-->
                                    <li class="theme-area">
                                        <ul class="colorpicker" id="skin-changer">
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#5DB2FF;" rel="/css/skins/blue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#2dc3e8;" rel="/css/skins/azure.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#03B3B2;" rel="/css/skins/teal.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#53a93f;" rel="/css/skins/green.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#FF8F32;" rel="/css/skins/orange.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#cc324b;" rel="/css/skins/pink.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#AC193D;" rel="/css/skins/darkred.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#8C0095;" rel="/css/skins/purple.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#0072C6;" rel="/css/skins/darkblue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#585858;" rel="/css/skins/gray.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#474544;" rel="/css/skins/black.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="index-rtl-ar.jsp#" style="background-color:#001940;" rel="/css/skins/deepblue.min.css"></a></li>
                                        </ul>
                                    </li>
                                    <!--/Theme Selector Area-->
                                    <li class="dropdown-footer">
                            ...
                            <a id="btn-setting" title="Setting" href="index-rtl-ar.jsp#">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        <a href="databoxes.jsp">
                            ...
                            <span class="menu-text"> صناديق البيانات </span>
                        </a>
                    </li>
                    <!--Widgets-->
                    <li>
                    ...
                    <!--UI Elements-->
                    <li>
                        <a href="index-rtl-ar.jsp#" class="menu-dropdown">
                            <i class="menu-icon fa fa-desktop"></i>
                            <span class="menu-text"> عناصر </span>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="elements.jsp">
                                    <span class="menu-text">عناصر الأساسية</span>
                                </a>
                            </li>
                            <li>
                                <a href="index-rtl-ar.jsp#" class="menu-dropdown">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li>
                                        <a href="glyph-icons.jsp">
                                            ...
                                            <span class="menu-text">Glyphicon</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="typicon.jsp">
                            ...
                            <li>
                                <a href="tabs.jsp">
                                    <span class="menu-text">علامات التبويب والأكورديون</span>
                                </a>
                            </li>
                            <li>
                                <a href="alerts.jsp">
                                    <span class="menu-text">تنبيهات وتلميحات</span>
                                </a>
                            </li>
                            <li>
                                <a href="modals.jsp">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="index-rtl-ar.jsp#">منزل</a>
                        </li>
                ...
                <div class="page-header position-relative">
                    ...
                    <div class="header-buttons">
                        <a class="sidebar-toggler" href="index-rtl-ar.jsp#">
                            <i class="fa fa-arrows-h"></i>
                        </a>
                        <a class="refresh" id="refresh-toggler" href="index-rtl-ar.jsp">
                            <i class="glyphicon glyphicon-refresh"></i>
                        </a>
                        <a class="fullscreen" id="fullscreen-toggler" href="index-rtl-ar.jsp#">
                                        ...
                                        <div class="box-tabbs">
                                            <div class="tabbable">
                                                <ul class="nav nav-tabs tabs-flat  nav-justified" id="myTab11">
                                                    <li class="active">
                                                        <a data-toggle="tab" href="index-rtl-ar.jsp#realtime">
                                                            في الوقت الحقيقي
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a data-toggle="tab" href="index-rtl-ar.jsp#visits">
                                                            مرة
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a data-toggle="tab" id="contacttab" href="index-rtl-ar.jsp#bandwidth">
                                                            عرض النطاق الترددي
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a data-toggle="tab" href="index-rtl-ar.jsp#sales">
                                                            مبيعات
                                                        </a>
                                                    </li>
                                                </ul>
                            ...
                            <div class="orders-container">
                                ...
                                <ul class="orders-list">
                                    <li class="order-item">
                                        ...
                                        <a class="item-more" href="index-rtl-ar.jsp">
                                            <i></i>
                                        </a>
                                    </li>
                                ...
                                <div class="orders-footer">
                                    <a class="show-all" href="index-rtl-ar.jsp"><i class="fa fa-angle-down"></i> تظهر جميع</a>
                                    <div class="help">
                                        <a href="index-rtl-ar.jsp"><i class="fa fa-question"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="task-container">
                                        ...
                                        <ul class="tasks-list">
                                            <li class="task-item">
                                                ...
                                                <div class="task-creator"><a href="index-rtl-ar.jsp">کامیرون هیتفیلد</a></div>
                                            ...
                                            <li class="task-item">
                                                ...
                                                <div class="task-creator"><a href="index-rtl-ar.jsp">بهرنج نیتسه</a></div>
                                            ...
                                            <li class="task-item">
                                                ...
                                                <div class="task-creator"><a href="index-rtl-ar.jsp">دیفید فینشر</a></div>
