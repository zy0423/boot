...
<head>
    ...
    <link id="bootstrap-rtl-link" href="inbox.jsp" rel="stylesheet" />
    ...
    <link id="skin-link" href="inbox.jsp" rel="stylesheet" type="text/css" />
        ...
        <div class="navbar-inner">
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="inbox.jsp#" class="navbar-brand">
                        <small>
                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li>
                                <a class=" dropdown-toggle" data-toggle="dropdown" title="Help" href="inbox.jsp#">
                            ...
                            <li>
                                <a class="wave in dropdown-toggle" data-toggle="dropdown" title="Help" href="inbox.jsp#">
                            ...
                            <li>
                                <a class="dropdown-toggle" data-toggle="dropdown" title="Tasks" href="inbox.jsp#">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li class="edit">
                                        ...
                                        <a href="inbox.jsp#" class="pull-right">Setting</a>
                                    </li>
                                    <!--Theme Selector Area-->
                                    <li class="theme-area">
                                        <ul class="colorpicker" id="skin-changer">
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#5DB2FF;" rel="/css/skins/blue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#2dc3e8;" rel="/css/skins/azure.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#03B3B2;" rel="/css/skins/teal.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#53a93f;" rel="/css/skins/green.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#FF8F32;" rel="/css/skins/orange.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#cc324b;" rel="/css/skins/pink.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#AC193D;" rel="/css/skins/darkred.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#8C0095;" rel="/css/skins/purple.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#0072C6;" rel="/css/skins/darkblue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#585858;" rel="/css/skins/gray.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#474544;" rel="/css/skins/black.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="inbox.jsp#" style="background-color:#001940;" rel="/css/skins/deepblue.min.css"></a></li>
                                        </ul>
                                    </li>
                                    <!--/Theme Selector Area-->
                                    <li class="dropdown-footer">
                            ...
                            <a id="btn-setting" title="Setting" href="inbox.jsp#">
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar menu-compact" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <!--UI Elements-->
                    <li>
                        <a href="inbox.jsp#" class="menu-dropdown">
            ...
            <div class="page-content">
                ...
                <div class="page-header position-relative mail-header">
                    ...
                    <div class="header-buttons">
                        <a class="sidebar-toggler" href="inbox.jsp#">
                            <i class="fa fa-arrows-h"></i>
                        </a>
                        <a class="refresh" id="refresh-toggler" href="inbox.jsp">
                            <i class="glyphicon glyphicon-refresh"></i>tooltip-primary
                        </a>
                        <a class="fullscreen" id="fullscreen-toggler" href="inbox.jsp#">
                    ...
                    <div class="mail-container">
                        <div class="mail-header">
                            <ul class="header-buttons">
                                <li>
                                    <a href="message-compose.jsp" class="tooltip-primary" data-toggle="tooltip" data-original-title="Compose"><i class="glyphicon glyphicon-pencil"></i></a>
                                </li>
                                <li>
                        ...
                        <div class="mail-body">
                            <ul class="mail-list">
                                <li class="list-item unread">
                                    ...
                                    <div class="item-star">
                                        <a href="inbox.jsp#" class="">
                                            <i class="fa fa-star-o"></i>
                                        </a>
                                    </div>
                                    <div class="item-sender">
                                        <a href="message-view.jsp" class="col-name">Bing</a>
                                    </div>
                                    ...
                                    <div class="item-options">
                                        <a href="message-view.jsp"><i class="fa fa-paperclip"></i></a>
                                    </div>
                                    <div class="item-time">
                                        Today, 13:52
                                    </div>
                                ...
                                <li class="list-item">
                                    ...
                                    <div class="item-sender">
                                        <a href="message-view.jsp" class="col-name">Codeplex Team</a>
                                    </div>
                                    <div class="item-subject">
                                        <a href="message-view.jsp">
                                ...
                                <li class="list-item">
                                    ...
                                    <div class="item-star">
                                        <a href="inbox.jsp#" class="stared">
                                            <i class="fa fa-star"></i>
                                        </a>
                                    </div>
                                    <div class="item-sender">
                                        <a href="message-view.jsp" class="col-name">Jaime</a>
                                    </div>
                                    <div class="item-subject">
                                        <a href="message-view.jsp">
                                ...
                                <li class="list-item">
                                    ...
                                    <div class="item-sender">
                                        <a href="message-view.jsp" class="col-name">La Liga</a>
                                    </div>
                                    <div class="item-subject">
                                ...
                                <li class="list-item unread">
                                    ...
                                    <div class="item-sender">
                                        <a href="message-view.jsp" class="col-name">Facebook</a>
                                    </div>
                                    <div class="item-subject">
                                        <a href="message-view.jsp">
                                ...
                                <li class="list-item">
                                    ...
                                    <div class="item-sender">
                                        <a href="message-view.jsp" class="col-name">Lorem Team</a>
                                    </div>
                                    <div class="item-subject">
                                        <a href="message-view.jsp">
