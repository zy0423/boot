...
<head>
    <meta charset="utf-8" />
    <title>Mail View Message</title>

    <meta name="description" content="Mail View Message" />
    ...
    <link id="bootstrap-rtl-link" href="message-view.jsp" rel="stylesheet" />
    ...
    <link id="skin-link" href="message-view.jsp" rel="stylesheet" type="text/css" />
        ...
        <div class="navbar-inner">
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="message-view.jsp#" class="navbar-brand">
                        <small>
                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li>
                                <a class=" dropdown-toggle" data-toggle="dropdown" title="Help" href="message-view.jsp#">
                            ...
                            <li>
                                <a class="wave in dropdown-toggle" data-toggle="dropdown" title="Help" href="message-view.jsp#">
                            ...
                            <li>
                                <a class="dropdown-toggle" data-toggle="dropdown" title="Tasks" href="message-view.jsp#">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li class="edit">
                                        ...
                                        <a href="message-view.jsp#" class="pull-right">Setting</a>
                                    </li>
                                    <!--Theme Selector Area-->
                                    <li class="theme-area">
                                        <ul class="colorpicker" id="skin-changer">
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#5DB2FF;" rel="/css/skins/blue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#2dc3e8;" rel="/css/skins/azure.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#03B3B2;" rel="/css/skins/teal.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#53a93f;" rel="/css/skins/green.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#FF8F32;" rel="/css/skins/orange.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#cc324b;" rel="/css/skins/pink.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#AC193D;" rel="/css/skins/darkred.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#8C0095;" rel="/css/skins/purple.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#0072C6;" rel="/css/skins/darkblue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#585858;" rel="/css/skins/gray.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#474544;" rel="/css/skins/black.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="message-view.jsp#" style="background-color:#001940;" rel="/css/skins/deepblue.min.css"></a></li>
                                        </ul>
                                    </li>
                                    <!--/Theme Selector Area-->
                                    <li class="dropdown-footer">
                            ...
                            <a id="btn-setting" title="Setting" href="message-view.jsp#">
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar menu-compact" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <!--UI Elements-->
                    <li>
                        <a href="message-view.jsp#" class="menu-dropdown">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="message-view.jsp#">Home</a>
                        </li>
                        <li>
                            <a href="message-view.jsp#">Mail</a>
                        </li>
                ...
                <div class="page-header position-relative mail-header">
                    ...
                    <div class="header-buttons">
                        <a class="sidebar-toggler" href="message-view.jsp#">
                            <i class="fa fa-arrows-h"></i>
                        </a>
                        <a class="refresh" id="refresh-toggler" href="message-view.jsp">
                            <i class="glyphicon glyphicon-refresh"></i>
                        </a>
                        <a class="fullscreen" id="fullscreen-toggler" href="message-view.jsp#">
                        ...
                        <div class="mail-body">
                            <div class="mail-info">
                                <div class="mail-sender">
                                    <a href="message-view.jsp#">
                                        <img src="/img/avatars/divyia.jpg" class="img-circle" width="30" />
                            ...
                            <div class="mail-attachments">
                                ...
                                <ul>
                                    <li>
                                        <a href="message-view.jsp#" class="thumb">
                                            <img src="/img/attach-blue.png" />
                                        </a>

                                        <a href="message-view.jsp#" class="name">
                                            attach-blue.png
                                            <span>16KB</span>
                                        </a>

                                        <div class="links">
                                            <a href="message-view.jsp#">View</a> -
                                            <a href="message-view.jsp#">Download</a>
                                        </div>
                                    </li>
                                    <li>
                                        <a href="message-view.jsp#" class="thumb download">
                                            <img src="/img/attach-yellow.png" />
                                        </a>
                            ...
                            <div class="mail-reply">
                                ...
                                <div class="reply-form">
                                    <div>
                                        <a href="message-compose.jsp">Reply</a> or <a href="message-view.jsp">Forward</a> this message...
                                    </div>
                                </div>
