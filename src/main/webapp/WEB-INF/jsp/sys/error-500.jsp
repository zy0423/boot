...
<head>
    ...
    <link id="bootstrap-rtl-link" href="error-500.jsp" rel="stylesheet" />
    ...
    <link id="skin-link" href="error-500.jsp" rel="stylesheet" type="text/css" />
...
<body class="body-500">
    ...
    <div class="container ">
        <section class="error-container text-center">
            ...
            <a href="index.jsp" class="return-btn"><i class="fa fa-home"></i>Home</a>
        </section>
    </div>
    <!--Basic Scripts-->
